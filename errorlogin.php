				...
				<h2>Log in</h2>
  				<form class="modal-content" action="#" method="POST">
					<div class="container">
      						...
      						<a href="mainpage.php"><button type="button" class="cancelbtn">Cancel</button></a><br><br><br>
                  <h6<strong style="color: white; float: right;"> You have Incorrect entered!</strong></h6>
					</div>
				</form>
