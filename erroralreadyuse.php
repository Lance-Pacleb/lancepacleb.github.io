...
<?php 
 ...
 if(isset($_POST['firstname'])){
    ...
    if($passwordinputone != $passwordinputtwo){
      ...
      if($num == 1){
        header('location:erroralreadyuse.php');
      }
      else
      {
        $sql = " INSERT INTO (Firstname,Lastname,Email,Address,Contact,Gender,Birthday,FirstPassword, SecondPassword)
				  ...
				  <center><h1>Create your Account</h1></center>
                   ...
                   <h5>Already use this Email!</h5>
		    				   ...
		    				   <input type="radio" name="gender" require value="male"> Male
							     ...
							     <input type="submit" value="Register" class="registerbtn" name="submitinfobtn"><br><br>
